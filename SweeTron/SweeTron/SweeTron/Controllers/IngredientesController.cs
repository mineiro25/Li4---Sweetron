...
namespace SweeTron.Controllers
{
    public class IngredientesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID_Ingrediente,Preço,Nome")] Ingrediente ingrediente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID_Ingrediente,Preço,Nome")] Ingrediente ingrediente)
        {
            if (ModelState.IsValid)
            {
